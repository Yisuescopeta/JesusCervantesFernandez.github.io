const profile = {
  ...
  interests: [
    ...
    'Aplicaciones multiplataforma con foco en experiencia de uso',
    'Videojuegos, prototipado técnico y tooling creativo',
    'IA aplicada a flujos de trabajo y producto',
  ],
  contacts: {
    github: {
      label: 'GitHub',
      value: '@Yisuescopeta',
      url: 'https://github.com/Yisuescopeta',
    },
    linkedin: {
      label: 'LinkedIn',
      value: 'Jesús Cervantes Fernández',
      url: 'https://www.linkedin.com/in/jes%C3%BAs-cervantes-fern%C3%A1ndez-835585419/',
    },
    email: {
      label: 'Email',
